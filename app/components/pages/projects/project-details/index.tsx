  ...
  return (
    <section className="w-full sm:min-h-[750px] flex flex-col items-center justify-end relative pb-10 sm:pb-24 py-24 px-6 overflow-hidden">
      <div
        ...
        style={{
          background:
            'url(/images/hero-bg.png) no-repeat center/cover, url(http://media.graphassets.com/7Kic5YHkQcmGrN57MSXw) no-repeat center/cover',
        }}
      />
      ...
      <div className="w-full max-w-[330ox] flex flex-wrap gap-2 items-center justify-center">
